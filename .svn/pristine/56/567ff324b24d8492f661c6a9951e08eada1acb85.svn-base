    ...
    public partial class DeletedList : System.Web.UI.Page
    {
        ...
        protected void viewLinkButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                LumexSessionManager.Add("SalesCenterIdForView", deletedListGridView.Rows[row.RowIndex].Cells[0].Text.ToString());
                Response.Redirect("~/UI/SalesCenter/View.aspx", false);
            }
            catch (Exception ex)
            {
                string message = ex.Message;
        ...
        protected void deletedListButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    DataTable dt = salesCenter.GetDeletedSalesCenterListByDateRangeAll(fromDate, toDate, "");
                    ...
                    {
                        msgbox.Visible = true; msgTitleLabel.Text = "Deleted Sales Center List Data Not Found!!!"; msgDetailLabel.Text = "";
        ...
        protected void GetAllDeletedList()
        {
            ...
            try
            {
                ...
                DataTable dt = salesCenter.GetDeletedSalesCenterListByDateRangeAll(fromDate, toDate, "All");
