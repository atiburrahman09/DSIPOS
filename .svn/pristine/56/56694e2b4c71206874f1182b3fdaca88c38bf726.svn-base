                    ...
                    <div class="widget-body no-padding">
                        <div class="grid-12">
                            <div class="widget-separator grid-3">
                                ...
                                <asp:DropDownList ID="accountHeadDropDownList" runat="server" CssClass="form form-full chosen-select" required="required">
                                </asp:DropDownList>
                            </div>
                            <div class="widget-separator grid-3">
                                <h5 class="typo">Amount<span class="text-error">*</span>
                                </h5>
                                <asp:TextBox ID="amountTextBox" runat="server" CssClass="form form-full" required="required"></asp:TextBox>
                            </div>
                            <div class="widget-separator grid-3">
                                <h5 class="typo">Bank Account Head<span class="text-error">*</span>
                                </h5>
                                <asp:DropDownList ID="bankAccountHeadDropDownList" runat="server" CssClass="form form-full" required="required">
                                </asp:DropDownList>
                            </div>
                            <div class="widget-separator grid-3">
                                <h5 class="typo">Voucher Number
                                </h5>
                                <asp:TextBox ID="voucherNumberTextBox" runat="server" CssClass="form form-full" required="required"></asp:TextBox>
                            </div>
                            <div class="widget-separator grid-3">
                                <h5 class="typo">Cheque Number<span class="text-error">*</span>
                                </h5>
                                <asp:TextBox ID="chequeNumberTextBox" runat="server" CssClass="form form-full" required="required"></asp:TextBox>
                            </div>
                            <div class="widget-separator grid-3">
                                <h5 class="typo">Cheque Date<span class="text-error">*</span></h5>
                                <div class="grid-12">
                                    <div class="grid-1">
                            ...
                            <div class="widget-separator grid-3">
                                ...
                                <asp:DropDownList ID="bankDropDownList" runat="server" CssClass="form form-full" required="required">
                                </asp:DropDownList>
                            </div>
                            <div class="widget-separator grid-3">
                                <h5 class="typo">Bank Branch
                                </h5>
                                <asp:TextBox ID="bankBranchTextBox" runat="server" CssClass="form form-full" required="required"></asp:TextBox>
                            </div>
                            <div class="widget-separator grid-3">
                                <h5 class="typo">Pay To/From<span class="text-error">*</span>
                                </h5>
                            ...
                            <div class="widget-separator grid-3">
                                ...
                                <div class="grid-11">
                                    <asp:DropDownList ID="drpdwnAccountOn" runat="server" CssClass="form form-full" OnSelectedIndexChanged="drpdwnAccountOn_SelectedIndexChanged"
                                        AutoPostBack="true">
