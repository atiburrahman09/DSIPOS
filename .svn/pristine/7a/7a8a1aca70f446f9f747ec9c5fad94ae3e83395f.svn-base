...
{
    public partial class UpdateDebitVoucherCheque : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    numberLabel.Text = journalNumberForUpdateHiddenField.Value = LumexSessionManager.Get("DVChequeJournalForUpdate").ToString().Trim();
                    GetDebitVoucherChequeByJournal(journalNumberForUpdateHiddenField.Value.Trim());
                }
            }
            catch (Exception ex)
            {
        ...
        protected void GetDebitVoucherChequeByJournal(string journalNumber)
        {
            DebitCreditVoucherBLL debitCreditVoucher = new DebitCreditVoucherBLL();

            try
            {
                DataTable dt = debitCreditVoucher.GetDebitVoucherApprovalByJournal("Cheque", journalNumber);
                ...
                {
                    msgbox.Visible = true; msgTitleLabel.Text = "Debit Voucher Cheque Data Not Found!!!"; msgDetailLabel.Text = "";
                    msgbox.Attributes.Add("class", "alert alert-warning");
                }
            }
            catch (Exception ex)
        ...
        protected void updateButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    debitCreditVoucher.UpdateDebitVoucherCheque();

                    string message = "Debit Voucher Cheque <span class='actionTopic'>Updated</span> Successfully.";
