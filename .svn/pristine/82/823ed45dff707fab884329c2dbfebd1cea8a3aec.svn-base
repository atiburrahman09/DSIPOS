...
namespace lmxIpos.UI.PurchaseToSC
{
    public partial class PurchaseList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            fromDateTextBox.Attributes.Add("autocomplete", "off");
            toDateTextBox.Attributes.Add("autocomplete", "off");
        ...
        protected void viewLinkButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("~/UI/PurchaseToSC/ApprovedPurchase.aspx");
            }
            catch (Exception ex)
            {
        ...
        protected void requisitionListButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    DataTable dt = purchaseRecord.GetPurchaseRecordsListBySalesCenterDateRangeAndStatus(salesCenterId, fromDate, toDate, status);
