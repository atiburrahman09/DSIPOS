...
{
    public partial class CreateCreditVoucherCheque : System.Web.UI.Page
    {
        ...
        protected void saveButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (amountTextBox.Text.Trim() == "" || System.Text.RegularExpressions.Regex.IsMatch(amountTextBox.Text, "[^0-9]"))
                {
                ...
                else if (chequeNumberTextBox.Text == "")
                {
                ...
                else
                {
                    ...
                    DataTable dt = debitCreditVoucher.SaveCreditVoucherCheque();

                    if (dt.Rows.Count > 0)
                    {
                        string message = "Credit Voucher Cheque <span class='actionTopic'>Created</span> Successfully with Voucher Number: <span class='actionTopic'>" + dt.Rows[0][0].ToString() + "</span>.";
                    ...
                    {
                        string message = "<span class='actionTopic'>Failed</span> to Create Credit Voucher Cheque.";
