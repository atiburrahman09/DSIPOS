    ...
    public partial class SalesOrderDetail : System.Web.UI.Page
    {
        ...
        protected void GetSalesOrderById(string salesOrderId)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    SalesPersonLabel.Text = dt.Rows[0]["SalesPersonName"].ToString();
                    PaymentModeLabel.Text = dt.Rows[0]["PaymentMode"].ToString();
                    PaymentInfoLabel.Text = dt.Rows[0]["AccountId"].ToString() + "-" + dt.Rows[0]["ChequeNumber"].ToString() + "-" + dt.Rows[0]["Bank"].ToString() + "-" + dt.Rows[0]["BankBranch"].ToString();
                    OtherSalesTextBox.Text = dt.Rows[0]["OthersDes"].ToString();
                    OthersSalesAmount.Text = dt.Rows[0]["OthersAmount"].ToString();
                    ...
                    ServiceAmountLabel.Text = dt.Rows[0]["ServiceAmount"].ToString();
                    ServiceChargeParLable.Text = dt.Rows[0]["ServicePercentage"].ToString();
        ...
        protected void btnAccept_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //salesOrder.DiscountAmount =DiscountAmountLabel.Text.Trim();
                //salesOrder.VAT = "0";//vatLabel.Text.Trim();
                //salesOrder.TotalReceivable = totalReceivableLabel.Text.Trim();
                //salesOrder.TotalVATAmount = "0";//VATamntLabel.Text.Trim();
