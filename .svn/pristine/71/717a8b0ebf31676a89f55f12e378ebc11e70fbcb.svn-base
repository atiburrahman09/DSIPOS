...
{
    public partial class DebitVoucherCashList : System.Web.UI.Page
    {
        ...
        protected void voucherListButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    DataTable dt = debitCreditVoucher.GetDebitVoucherApprovalListByDateRangeAndAll(drpdwnSalesCenterOrWarehouse.SelectedValue, fromDate, toDate, "Cash", "");
        ...
        protected void editLinkButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                LumexSessionManager.Add("DVCashJournalForUpdate", voucherListGridView.Rows[row.RowIndex].Cells[0].Text.ToString());
                Response.Redirect("~/UI/AccUI/DebitVoucher/UpdateDebitVoucherCash.aspx", false);
            }
            catch (Exception ex)
            {
                string message = ex.Message;
