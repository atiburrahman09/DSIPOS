    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="true">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-8">
                    <i>&#xf132;</i>Warehouse Purchase Record Form<span>Creating Warehouse Purchase Record</span></h1>
            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">Create Warehouse Purchase Record Form</h3>
                    </header>
                    <div class="widget-body no-padding">
                        <div class="widget-separator no-padding grid-12">
                            <div class="widget-separator no-border grid-3">
                                <h5 class="typo">Warehouse Name<span class="text-error">*</span>
                                </h5>
                            ...
                            <div class="widget-separator no-border grid-5" style="margin-top: 28px;">
                        ...
                        <div class="widget-separator no-padding grid-12">
                            <div class="widget-separator no-border grid-3">
                                ...
                                <asp:DropDownList ID="vendorDropDownList" runat="server" required="required" CssClass="form form-full chosen-select">
                                </asp:DropDownList>
                            </div>
                            <div class="widget-separator no-border grid-3">
                                <div class="grid-12">
