<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="CreateCreditVoucherCash.aspx.cs" Inherits="lmxIpos.UI.AccUI.CreditVoucher.CreateCreditVoucherCash" %>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="True">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>Create C.V. Cash<span>Creating C.V. Cash</span></h1>
            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">Create Credit Voucher Cash Form</h3>
                    </header>
                    <div class="widget-body no-padding">
                        <div class="grid-12">
                            ...
                            <div class="widget-separator grid-3">
                                <h5 class="typo">Cash Account Head<span class="text-error">*</span>
                                </h5>
                            ...
                            <div class="widget-separator grid-3">
                                ...
                                <div class="grid-12">
                                    <asp:DropDownList ID="drpdwnAccountOn" CssClass="form form-full" runat="server" OnSelectedIndexChanged="drpdwnAccountOn_SelectedIndexChanged"
                                        AutoPostBack="true">
