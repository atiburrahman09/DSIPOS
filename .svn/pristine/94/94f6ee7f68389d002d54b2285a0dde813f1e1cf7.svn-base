...
{
    public partial class DebitVoucherChequeList : System.Web.UI.Page
    {
        ...
        protected void editLinkButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                LumexSessionManager.Add("DVChequeJournalForUpdate", voucherListGridView.Rows[row.RowIndex].Cells[0].Text.ToString());
                Response.Redirect("~/UI/AccUI/DebitVoucher/UpdateDebitVoucherCheque.aspx", false);
            }
            catch (Exception ex)
            {
                string message = ex.Message;
