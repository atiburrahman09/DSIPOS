...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
        ...
        <div class="grid-12">
            ...
            <div class="widget">
                ...
                <div class="widget-body no-padding">
                    ...
                    <div class="widget-separator no-border grid-3">
                        <h5 class="typo"><span>আলমারি নং<span class="text-error">*</span></span></h5>
                        <asp:TextBox ID="txtbxAlmariNo" CssClass="  form form-full" runat="server"></asp:TextBox>
                    </div>
                    <div class="widget-separator no-border grid-3">
                        <h5 class="typo"><span>তাক নং<span class="text-error">*</span></span></h5>
                        <asp:TextBox ID="txtbxTakNo" CssClass="  form form-full" runat="server"></asp:TextBox>
                    </div>


                    <div class="widget-separator no-border grid-3">
                        <h5 class="typo"><span>কলাম নং<span class="text-error">*</span></span></h5>
                        <asp:TextBox ID="txtbxKolamNo" CssClass="  form form-full" runat="server"></asp:TextBox>
                    </div>
                    <div class="widget-separator no-border grid-3">
                        <h5 class="typo"><span>কিতাব নং<span class="text-error">*</span></span></h5>
                    ...
                    <div class="widget-separator grid-6">
                        <asp:Button ID="btnSave" CssClass="btn btn-info btn-3d " runat="server" Text="Save" OnClick="btnSave_OnClick" />
                    </div>
                    <div class="widget-separator grid-6">
                        <div class="grid-6">
    ...
    <asp:HiddenField ID="noHiddenField" runat="server" />
