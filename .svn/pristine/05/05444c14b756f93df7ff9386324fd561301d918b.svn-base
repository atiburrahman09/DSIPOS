    ...
    public partial class Create : System.Web.UI.Page
    {
        ...
        private void GetTotalRowForBookID()
        {
            try
            {
                ...
                txtbxKitaberSerialNo.Text= noHiddenField.Value = dt.Rows[0][0].ToString();
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    aBook.KitaberMainLanguage = mainLanguageDropDownList.SelectedItem.Text;
                    aBook.KitaberMainLanguageValue = mainLanguageDropDownList.SelectedValue;
                    aBook.KitaberTranslateLanguage = translatedLanguageDropDownList.SelectedItem.Text;
