<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="JournalVoucherList.aspx.cs" Inherits="lmxIpos.UI.AccUI.JournalVoucher.JournalVoucherList" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>Journal Voucher List<span>Created Journal Voucher List</span></h1>
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">
                            System Journal Voucher List</h3>
                    </header>
                            ...
                            <div id="voucherListGridContainer">
                                <asp:GridView ID="voucherListGridView" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PayToFromCompany" HeaderText="Pay To From Company" />
