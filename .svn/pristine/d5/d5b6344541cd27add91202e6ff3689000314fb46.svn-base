<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CustomerReceivePaymentList.aspx.cs" Inherits="lmxIpos.UI.ReceiveFromCustomer.CustomerReceivePaymentList" %>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="true">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-8">
                    <i>&#xf132;</i>Customer Payment List<span>Customer Payment List</span></h1>
                    ...
                    <div class="widget-body no-padding">
                        <div class="widget-separator no-padding grid-12">
                            ...
                            <div class="widget-separator no-border grid-3">
                                <h5 class="typo">
                                    <asp:Label ID="vendorLabel" runat="server" Text="Customer"></asp:Label>
                                </h5>
                                <asp:DropDownList ID="customerDropDownList" runat="server" CssClass="form form-full"
                                    required="required">
                                </asp:DropDownList>
                            </div>
                            ...
                            <div class="widget-separator no-border grid-3">
                                ...
                                <asp:Button ID="recordListButton" runat="server" Text="Get Customer Payment List" CssClass="btn btn-info"
                                    OnClick="btnCustomerPaymentList_OnClick" />
                            </div>
                        ...
                        <div class=" widget-separator no-border grid-12">
                            <div id="salesRecordListGridContainer">
                                <asp:GridView ID="customerPaymentListGridView" runat="server" AutoGenerateColumns="false"
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="customerPaymentListGridView" EventName="RowDataBound" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptContentPlaceHolder" runat="server">
     <script type="text/javascript">
         function pageLoad(sender, args) {
             ...
             $("#customerPaymentListGridView").dataTable();
         }
    </script>
</asp:Content>
