<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="ApprovedPurchase.aspx.cs" Inherits="lmxIpos.UI.PurchaseToSC.ApprovedPurchase" %>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="true">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-8">
                    <i>&#xf132;</i>Sales Center Purchase Record<span>Approved Sales Center Purchase Record</span></h1>
            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">Sales Center Purchase Record of
                        ...
                        <div id="orderInfoContainer">
                            ...
                            <div class="grid-12">
                                ...
                                <div class="widget-separator grid-4">
                                    ...
                                    <div class="grid-8">
                                        <asp:Label ID="totalPayableLabel" runat="server" Text="" CssClass="infoLabel text-warning bolder"></asp:Label>
                                    </div>
                                </div>
                                <div class="widget-separator grid-4">
                                    <div class="grid-4">
