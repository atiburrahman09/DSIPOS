...
{
    public partial class GeneralLedgerReport : System.Web.UI.Page
    {
        ...
        protected void generateButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                iposReport.GetGeneral_ledger_Sheet_Report_by_Date(reportTypeDropDownList.SelectedValue, SCWHDropDownList.SelectedValue, toDateTextBox.Text, fromDateTextBox.Text);
