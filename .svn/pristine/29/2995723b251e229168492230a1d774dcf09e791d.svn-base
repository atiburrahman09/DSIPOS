<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="ApprovePurchase.aspx.cs" Inherits="lmxIpos.UI.PurchaseToSC.ApprovePurchase" %>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="true">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-9">
                    <i>&#xf132;</i>Approve Sales Center Purchase Record<span>Approving Sales Center Purchase
                        Record</span></h1>
            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">Approve Sales Center Purchase Record of
                        ...
                        <div id="orderInfoContainer">
                            ...
                            <div class="widget-separator no-padding grid-12">
                                <div class="widget-separator grid-6">
                                    ...
                                    <div class="grid-8">
                                        <asp:Label ID="salesCenterIdLabel" runat="server" Text="" CssClass="infoLabel"></asp:Label> &                                     <asp:Label ID="salesCenterNameLabel" runat="server" Text="" CssClass="infoLabel"></asp:Label>
                                    </div>
                                </div>
                               <%-- <div class="widget-separator grid-6">
                                    <div class="grid-4">
                            ...
                            <div class="grid-12">
                                ...
                                <div class="widget-separator grid-4">
                                    ...
                                    <div class="grid-8">
                                        <asp:Label ID="totalPayableLabel" runat="server" Text="" CssClass="infoLabel text-error bolder"></asp:Label>
                                    </div>
                                </div>
                                <div class="widget-separator grid-4">
                                    <div class="grid-4">
                                ...
                                <div class="widget-separator grid-4">
                                    ...
                                    <div class="grid-8">
                                        <asp:Label ID="paidAmountLabel" runat="server" Text="" CssClass="infoLabel text-success bolder"></asp:Label>
                                    </div>
                                </div>
                            </div>
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="purchaseOrderProductListGridView" EventName="RowDataBound" />
