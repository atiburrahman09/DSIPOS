    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>C.V. Cash List<span>Created C.V. Cash List</span></h1>
            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">System Credit Voucher Cash List</h3>
                    </header>
    ...
    <script type="text/javascript">
        function pageLoad(sender, args) {
            ...
            $("#viewDetailsModal").on("shown", function () {
                $.ajax({
                    type: "POST",
                    url: "/UI/AccUI/CreditVoucher/CreditVoucherCashList.aspx/GetCreditVoucherViewByJournal",
