...
{
    public partial class ApproveCreditVoucherCash : System.Web.UI.Page
    {
        ...
        public static string GetCreditVoucherViewByJournal(string journalNumber)
        {
            try
            {
                ...
                string json = JsonConvert.SerializeObject(debitCreditVoucher.GetCreditVoucherApprovalByJournal("Cash", journalNumber));
        ...
        protected void approveButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                for (int i = 0; i < voucherListGridView.Rows.Count; i++)
                {
                    ...
                    {
                        debitCreditVoucher.ApproveCreditVoucherByJournal(voucherListGridView.Rows[i].Cells[0].Text.Trim(), "Cash");
                        count++;
                    }
                }
                ...
                {
                    GetApprovalList();
                    string message = count.ToString() + " Credit Voucher Cash(s) <span class='actionTopic'>Approved</span> Successfully.";
        ...
        protected void rejectButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    GetApprovalList();
                    string message = count.ToString() + " Credit Voucher Cash(s) <span class='actionTopic'>Rejected</span> Successfully.";
                    MyAlertBox("SuccessAlert(\"" + "Process Succeed" + "\", \"" + message + "\", \"\");");
                }
                else
                {
        ...
        protected void approveLinkButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                debitCreditVoucher.ApproveCreditVoucherByJournal(journalNumberForApproveHiddenField.Value.Trim(), "Cash");

                GetApprovalList();
                string message = "Credit Voucher Cash <span class='actionTopic'>Approved</span> Successfully.";
                MyAlertBox("SuccessAlert(\"" + "Process Succeed" + "\", \"" + message + "\", \"\");");
            }
            catch (Exception ex)
            {
        ...
        protected void rejectLinkButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                GetApprovalList();
                string message = "Credit Voucher Cash <span class='actionTopic'>Rejected</span> Successfully.";
                MyAlertBox("SuccessAlert(\"" + "Process Succeed" + "\", \"" + message + "\", \"\");");
            }
            catch (Exception ex)
            {
