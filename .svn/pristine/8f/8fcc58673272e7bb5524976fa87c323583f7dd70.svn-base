<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="lmxIpos.UI.AccUI.PayToFromCompany.List" %>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="true">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-7">
                    <i>&#xf132;</i>Pay To/From Company List<span>Created Pay To/From Company List</span></h1>
            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">System Pay To/From Company List</h3>
                    </header>
                                    ...
                                    <asp:TemplateField HeaderText="Edit">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="editLinkButton" runat="server" CssClass="btn btn-info btn-flat-3d"
                                                OnClick="editLinkButton_Click"><span class="icon icon-2x icon-info text-error"></span></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
        ...
        $(function () {
            ...
            $(".clickProcessing").live("click", function (e) {
                if (haveOverlay == 0) {
                    ...
                    companyId = $("#payToFromCompanyListGridView").find("tr td:nth-child(1)").eq(row).text();
                    isActive = $("#payToFromCompanyListGridView").find("tr td:nth-child(4)").eq(row).text();
                    ...
                    if (isActive == "True" && id == "activateLinkButton") {
                        WarningAlert("Process Redundant", "This Company <span class='actionTopic'>already activated</span>.", "");
                    }
                    else if (isActive == "False" && id == "deactivateLinkButton") {
                        WarningAlert("Process Redundant", "This Company <span class='actionTopic'>already deactivated</span>.", "");
                    }
                    else {
                        if (id == "activateLinkButton") {
                            msg = "Are you sure you want to <span class='actionTopic'>activate</span> this Company?";
                        }
                        else if (id == "deactivateLinkButton") {
                            msg = "Are you sure you want to <span class='actionTopic'>deactivate</span> this Company?";
                        }
                        else if (id == "deleteLinkButton") {
                            msg = "Are you sure you want to <span class='actionTopic'>delete</span> this Company?";
                        }
