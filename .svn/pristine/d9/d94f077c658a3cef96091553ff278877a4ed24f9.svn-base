            ...
            try
            {
                ...
                if (user.ValidateUser())
                {
                    ...
                    if (dt.Rows[0]["IsActive"].ToString() == "True" && dt.Rows[0]["IsUserGroupActive"].ToString() == "True")
                    {
                        ...
                        LumexSessionManager.Add("Userapp",drpdownApplication.SelectedValue);

                        if(drpdownApplication.SelectedValue=="invacc")
                        {
                            LumexSessionManager.Add("ActiveMenuFor", "inv");
                        }
                        else
                        {
                            LumexSessionManager.Add("ActiveMenuFor", drpdownApplication.SelectedValue);
                        }
