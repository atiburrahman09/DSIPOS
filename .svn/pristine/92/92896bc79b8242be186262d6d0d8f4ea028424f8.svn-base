<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="DebitVoucherChequeListView.aspx.cs" Inherits="lmxIpos.UI.AccUI.DebitVoucher.DebitVoucherChequeListView" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>D.V. Cheque List View<span>Created D.V. Cheque List View</span></h1>
            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">System Debit Voucher Cheque List View</h3>
                    </header>
                    <div class="widget-body no-padding">
                        <div class="widget-separator no-padding grid-12">
                            ...
                            <div class="widget-separator no-border grid-3">
                                ...
                                <div class="grid-11">
                                    <asp:DropDownList ID="drpdwnSalesCenterOrWarehouse" CssClass="form form-full" runat="server">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="widget-separator no-border grid-3">
                                ...
                                <div class="grid-11">
                                    ...
                                    <div class="grid-11">
                                        <asp:TextBox ID="fromDateTextBox" CssClass="date-textbox form form-full" runat="server" autocomplete="off"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="widget-separator no-border grid-3">
                                ...
                                <div class="grid-11">
                                    ...
                                    <div class="grid-11">
                                        <asp:TextBox ID="toDateTextBox" CssClass="date-textbox form form-full" runat="server" autocomplete="off"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        function pageLoad(sender, args) {
            ...
            $("#viewDetailsModal").on("shown", function () {
                $.ajax({
                    type: "POST",
                    url: "/UI/AccUI/DebitVoucher/DebitVoucherChequeListView.aspx/GetDebitVoucherViewByJournal",
                    ...
                    success: function (data) {
                        ...
                        if (obj.PayToFromCompany == null) {
                            $("#payToFromCompanyLabel").text("N/A");
                        }
                        else {
                            $("#payToFromCompanyLabel").text(obj.PayToFromCompany);
                        }
