    ...
    public partial class CreateSalesOrder : System.Web.UI.Page
    {
        ...
        protected void LoadChartOfAccountsCashAndBankHeadList()
        {
            ...
            try
            {
                ...
                //accountHeadDropDownList.Items.Insert(0, "Select.....");
        ...
        protected void saveButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    salesOrder.ChequeDate = LumexLibraryManager.ParseAppDate("1/1/1900");//LumexLibraryManager.ParseAppDate(chequeDateTextBox.Text.Trim());
                }
                else
                {
                ...
                if (salesOrder.creditStatus == 'P')
                {
                    ...
                    {
                        salesOrder.ServiceAmount = (changeAmountCal * (-1) * (18 / 100)).ToString();
                    }
                ...
                salesOrder.DiscountPercentage = txtbxdiscountPer.Text;
                salesOrder.VAT = "0";
                ...
                salesOrder.TotalVATAmount = "0";//totalVATAmountHiddenField.Value;
                if (salesOrder.TotalVATAmount == "")
                {
                    salesOrder.TotalVATAmount = "0.00";
                }
                ...
                if (dtPrdList.Rows.Count == selectedProductListGridView.Rows.Count)
                {
                    ...
                    if (!string.IsNullOrEmpty(salesRecordId))
                    {
                        ...
                        ////receivePayment.ChequeDate = LumexLibraryManager.ParseAppDate(chequeDateTextBox.Text.Trim()); 
                        //if (paymentModeDropDownList.SelectedValue == "Cash")
                        //{
                        //    salesOrder.ChequeDate = LumexLibraryManager.ParseAppDate("1/1/1900");//LumexLibraryManager.ParseAppDate(chequeDateTextBox.Text.Trim());
                        //}
                        ...
                        //DataTable dt = new DataTable();
                        //if (Convert.ToDecimal(receivePayment.Amount) <= Convert.ToDecimal(salesOrder.ChangeAmount) &&
                        //    Convert.ToDecimal(receivePayment.Amount) > 0)
                        //{
