...
{
    public partial class CreditVoucherChequeListView : System.Web.UI.Page
    {
        ...
        protected void voucherListButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    DataTable dt = debitCreditVoucher.GetCreditVoucherApprovedListByDateRangeAndAll(drpdwnSalesCenterOrWarehouse.SelectedValue, fromDate, toDate, "Cheque", "");
        ...
        protected void allVoucherListButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dt = debitCreditVoucher.GetCreditVoucherApprovedListByDateRangeAndAll(drpdwnSalesCenterOrWarehouse.SelectedValue, fromDate, toDate, "Cheque", "All");
        ...
        public static string GetCreditVoucherViewByJournal(string journalNumber)
        {
            try
            {
                ...
                string json = JsonConvert.SerializeObject(debitCreditVoucher.GetCreditVoucherApprovedByJournal("Cheque", journalNumber));
