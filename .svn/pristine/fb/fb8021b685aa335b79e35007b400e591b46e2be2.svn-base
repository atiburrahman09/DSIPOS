<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="CreateSalesOrder.aspx.cs" Inherits="lmxIpos.UI.SalesOrder.CreateSalesOrder" EnableEventValidation="false" %>
                ...
                <div class="widget">
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <div class="widget-separator grid-12">
                            ...
                            <div class="widget-separator no-border grid-3" style="padding-top: 3px;">
                        ...
                        <div class="widget-separator no-padding grid-12">
                            ...
                            <div class="widget-separator no-border grid-3">
                                <h5 class="typo">Delivery date<span class="text-error">*</span>
                                </h5>
                                <asp:TextBox ID="deliveryDateTextBox" runat="server" placeholder="Delivery Date" CssClass="date-textbox form form-full autoCompeleteOff"></asp:TextBox>
                            </div>
                            <div class="widget-separator no-border grid-3">
                                <h5 class="typo">Narration
                                </h5>
                                <asp:TextBox ID="txtNaration" runat="server" placeholder="Narration" CssClass="form form-full autoCompeleteOff"></asp:TextBox>
                            </div>
                            <%--<div class="widget-separator no-border grid-3">
                        ...
                        <div class="widget-separator no-padding grid-12">
                            <%--<div class="grid-6" style="float: right;">
                                ...
                                <div class="widget-separator no-border grid-12">
                                    ...
                                    <div class="grid-4 control-group input-append">
                                        <asp:TextBox ID="vatTextBox" CssClass="autoCompeleteOff" Width="40%" onfocus="this.select()" PlaceHolder="Discount (%)"
                                            runat="server"></asp:TextBox>
                                    ...
                                    <div class="grid-3">
                                        ...
                                        <asp:CompareValidator ID="CompareValidator5" runat="server" ErrorMessage="Tk. Only" ControlToValidate="vatTextBox"
                                            ValidationGroup="2" Type="Currency" Operator="DataTypeCheck" ForeColor="Red" Display="Dynamic" Font-Size="Small"
                                            Visible="true"> </asp:CompareValidator>
                                    </div>
                                </div>
                                <div class="widget-separator no-border grid-12">
                                    ...
                                    <div class="grid-3">
                                        <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Tk. Only" ControlToValidate="receivableAmountTextBox"
                                            ValidationGroup="2" Type="Currency" Operator="DataTypeCheck" ForeColor="Red" Display="Dynamic" Font-Size="Small"
                                            Visible="true"> </asp:CompareValidator>
                                    </div>
                                </div>
                                <div class="widget-separator no-border grid-12">
                                    ...
                                    <div class="grid-4">
                                        <asp:TextBox ID="receivedAmountTextBox" onfocus="this.select();" Text="0.00" CssClass="form form-full autoCompeleteOff"
                                            PlaceHolder="0.00" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="grid-3">
                                        <asp:CompareValidator ID="cmpVldCurrency" runat="server" ErrorMessage="Tk. Only" ControlToValidate="receivedAmountTextBox"
                                            ValidationGroup="2" Type="Currency" Operator="DataTypeCheck" ForeColor="Red" Display="Dynamic" Font-Size="Small"
                                            Visible="true"> </asp:CompareValidator>
                                    </div>
                                </div>
                                <div class="widget-separator no-border grid-12">
                                    ...
                                    <div class="grid-3">
                                        <asp:CompareValidator ID="CompareValidator6" runat="server" ErrorMessage="Tk. Only" ControlToValidate="DuesAmoutPayTextBox"
                                            ValidationGroup="2" Type="Currency" Operator="DataTypeCheck" ForeColor="Red" Display="Dynamic" Font-Size="Small"
                                            Visible="true"> </asp:CompareValidator>
                                    </div>
                                </div>
                            ...
                            <div class="grid-6" style="float: right;">
                                ...
                                <div class="widget-separator no-border grid-12">
                                    ...
                                    <div class="grid-4">
                                        <asp:TextBox ID="totalAmountTextBox" CssClass="read-only form form-full" TabIndex="1" onfocus="this.selec()" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="grid-3">
                                        <asp:CompareValidator ID="CompareValidator2" runat="server" ErrorMessage="Tk. only." ControlToValidate="totalAmountTextBox"
                                            ValidationGroup="2" Type="Currency" Operator="DataTypeCheck" ForeColor="Red" Display="Dynamic" Font-Size="Small"
                            ...
                            <div id="CustomerInformation" class="grid-6" style="float: left;" runat="server">
                                <div class="widget-separator grid-12">
                                    <div class="grid-8">
                        ...
                        <div class="grid-12 text-center">
                            ...
                            <asp:Button ID="saveButton" CssClass="btn btn-submit btn-3d btn-large" Enabled="false"
                                runat="server" Text="Confirm Sales Order" OnClick="saveButton_Click" ValidationGroup="2" />
                            <%--  </div>--%>
                            <%--<div class="grid-5">
                                &nbsp;
                            </div>--%>
...
<asp:Content ID="scriptContent" ContentPlaceHolderID="scriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        function pageLoad(sender, args) {
            ...
            //$.ajax({
            //    type: "POST",
            //    url: "/Services/ProductSearchforSale.ashx",
            //    success: function (d) {
            //        var array = [];
            ...
            function OthersCalculation() {
                ...
                $("#receivableAmountTextBox").val(receivable.toFixed(2));
                $("#changeAmountTextBox").val((received - receivable).toFixed(2));
