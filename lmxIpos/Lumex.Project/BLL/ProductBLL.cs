...
namespace Lumex.Project.BLL
{
    public class ProductBLL
    {
        ...
        public DataTable GetProductNamesBySalesCenter(string id)
        {
            ...
            {
                LumexDBPlayer db = LumexDBPlayer.Start();
                DataTable dt = product.GetProductNamesBySalesCenter(id, db);
                db.Stop();
        ...
        public DataTable GetActiveProductListByUser(string UserId)
        {
            ProductDAL product = new ProductDAL();
            ...
            {
                LumexDBPlayer db = LumexDBPlayer.Start();
                DataTable dt = product.GetActiveProductListByUser(UserId, db);
                db.Stop();
        ...
        public DataTable GetProductListbyGroupId(string GroupId)
        {
            ProductDAL product = new ProductDAL();
            ...
            {
                LumexDBPlayer db = LumexDBPlayer.Start();
                DataTable dt = product.GetProductListbyGroupId(GroupId, db);
                db.Stop();
        ...
        public DataTable SearchProductByIdorBarcode(string Id)
        {
            ...
            {
                LumexDBPlayer db = LumexDBPlayer.Start();
                DataTable dt = product.SearchProductByIdorBarcode(Id, db);
                db.Stop();
