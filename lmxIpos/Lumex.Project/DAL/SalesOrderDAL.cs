    ...
    public class SalesOrderDAL
    {
        public string SaveSalesOrder(SalesOrderBLL salesOrder, DataTable dtPrdList, LumexDBPlayer db)
        {
            ...
            try
            {
                ...
                db.AddParameters("@CreditStatus", salesOrder.creditStatus);
                ...
                {
                    db.AddParameters("@AddedServiceCharge", salesOrder.ServiceAmount);
                    db.AddParameters("@ServiceAmount", "0.00");
                }
                else
                {
                    db.AddParameters("@AddedServiceCharge", "0.00");
                    db.AddParameters("@ServiceAmount", salesOrder.ServiceAmount);
                }
        ...
        public string SaveRetailSales(SalesOrderBLL salesOrder, DataTable dtPrdList, LumexDBPlayer db)
        {
            ...
            try
            {
                ...
                {
                    db.AddParameters("@AddedServiceCharge", "0.00");
                    db.AddParameters("@ServiceAmount", salesOrder.ServiceAmount.Trim());
                }
