...
namespace lmxIpos
{
    public partial class App : System.Web.UI.MasterPage
    {
        ...
        private void PopulatSideberemenu()
        {
            ...
            if (LumexSessionManager.Get("Userapp").ToString() == "invacc")
            {
                lnlbtnInventory.Visible = true;
                lnlbtnAccounts.Visible = true;
                lnkbtnLibrary.Visible = false;
                lnkbtnAddv.Visible = false;
            }
            else if (LumexSessionManager.Get("Userapp").ToString() == "inv")
            {
                lnlbtnInventory.Visible = true;
                lnlbtnAccounts.Visible = false;
                lnkbtnLibrary.Visible = false;
                lnkbtnAddv.Visible = false;
            }
            else if (LumexSessionManager.Get("Userapp").ToString() == "acc")
            {
                lnlbtnInventory.Visible = false;
                lnlbtnAccounts.Visible = true;
                lnkbtnLibrary.Visible = false;
                lnkbtnAddv.Visible = false;
            }
            else if (LumexSessionManager.Get("Userapp").ToString() == "lib")
            {
                lnlbtnInventory.Visible = false;
                lnlbtnAccounts.Visible = false;
                lnkbtnLibrary.Visible = true;
                lnkbtnAddv.Visible = false;
            }
            else if (LumexSessionManager.Get("Userapp").ToString() == "addv")
            {
                lnlbtnInventory.Visible = false;
                lnlbtnAccounts.Visible = false;
                lnkbtnLibrary.Visible = false;
                lnkbtnAddv.Visible = true;
            }
        ...
        private void PopulateUserMenuForDeveloper(string menufor)
        {
            ...
            try
            {
                if ((string)LumexSessionManager.Get("isMenu") == "N")
                {
                    ...
                    {
                        LumexSessionManager.Add("menulib", dtUserMenu);
                    }
                    // LumexSessionManager.Add("IsMenu", "Y");
                }
                ...
                if ((string)LumexSessionManager.Get("isMenu") == "N")
                {
                    ...
                    else
                    {
                        for (int i = 0; i < dtUserMenu.Rows.Count; i++)
                        {
                            ...
                            {
                                path = "Done";
                                Page.Title = dtUserMenu.Rows[i]["DisplayName"].ToString();
                                break;
                            }
                        }
                    }
        ...
        protected void lnlbtnInventory_Click(object sender, EventArgs e)
        {
            ...
            lnkbtnAddv.Attributes.Remove("class");
            lnkbtnLibrary.Attributes.Remove("class");
        }
        ...
        protected void lnkbtnLibrary_Click(object sender, EventArgs e)
        {
            LumexSessionManager.Add("ActiveMenuFor", "lib");
        ...
        protected void lnkbtnAddv_Click(object sender, EventArgs e)
        {
            LumexSessionManager.Add("ActiveMenuFor", "addv");
