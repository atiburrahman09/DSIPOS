<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="lmxIpos.Login" EnableEventValidation="false" %>
            ...
            <h4 class="typo login-title">Login
              ...
              <div class="form-separator form-field">
                <div class="field-icon field-icon-left">
                    ...
                    <asp:DropDownList ID="drpdownApplication" class="form form-full" runat="server">

                        <asp:ListItem Value="inv">Inventory</asp:ListItem>
                        <asp:ListItem Value="acc">Accounts</asp:ListItem>
                        <asp:ListItem Value="invacc">Inventory &amp; Accounts</asp:ListItem>
                        <asp:ListItem Value="lib">লাইব্রেরী</asp:ListItem>
                        <asp:ListItem Value="addv">বিজ্ঞাপন</asp:ListItem>
                    </asp:DropDownList>
                </div>
            </div>
            <div class="form-separator form-field">
