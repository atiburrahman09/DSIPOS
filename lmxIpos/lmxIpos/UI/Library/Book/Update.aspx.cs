    ...
    public partial class Update : System.Web.UI.Page
    {
        ...
        protected void UpdateUserInfo()
        {
            ...
            try
            {
                ...
                bookBll.No = LumexSessionManager.Get("BookIdForUpdate").ToString();
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    txtbxKitaberSerialNo.ReadOnly = true;
                    ...
                    mainLanguageDropDownList.SelectedValue = dt.Rows[0]["BookLanguageValue"].ToString();
                    translatedLanguageDropDownList.SelectedValue = dt.Rows[0]["TranslateLanguageValue"].ToString();
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    aBook.KitaberMainLanguageValue = mainLanguageDropDownList.SelectedValue;
                    aBook.KitaberTranslateLanguage = translatedLanguageDropDownList.SelectedItem.Text.Trim();
                    aBook.KitaberTranslateLanguageValue = translatedLanguageDropDownList.SelectedValue;
