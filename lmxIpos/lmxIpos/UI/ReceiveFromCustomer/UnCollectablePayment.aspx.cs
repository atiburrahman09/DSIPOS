...
namespace lmxIpos.UI.ReceiveFromCustomer
{
    public partial class UnCollectablePayment : System.Web.UI.Page
    {
        ...
        protected void GetSalesRecordById(string salesRecordId)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    lblUncollectedAmount.Text = dt.Rows[0]["UncollectableAmount"].ToString();
                    ...
                    if (Convert.ToDecimal(dueAmountLabel.Text) <= 0)
                    {
        ...
        protected void saveButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Convert.ToDecimal(uncollectableAmountTextBox.Text) > 0)
                {
