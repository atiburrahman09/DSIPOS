                    ...
                    <div class="widget-body no-padding">
                        ...
                        <div class="accordion" id="accordion2">
                                        ...
                                        <div id="orderInfoContainer">
                                            ...
                                            <div class="grid-12">
                                                ...
                                                <div class="widget-separator grid-6">
                                                    ...
                                                    <div class="grid-8">
                                                        <asp:Label ID="UncollectedAmountLabel" runat="server" Text="" CssClass="text-warning"></asp:Label>
                                                    </div>
                                                </div>
                                                <div class="widget-separator grid-6">
                                                    <div class="grid-4">
                                                    ...
                                                    <div class="grid-8">
                                                        <asp:Label ID="receivedAmountLabel" runat="server" Text="" CssClass="text-success"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="grid-12">
                                ...
                                <div class="widget-separator grid-4">
                                    <h5 class="typo">Return Amount (-Disc.):
                                    </h5>
                                ...
                                <div class="widget-separator grid-4">
                                    <h5 class="typo">Return Service Charge:
                                    </h5>
                                    <div class="grid-8">
...
<asp:Content ID="scriptContent" ContentPlaceHolderID="scriptContentPlaceHolder" runat="server">
    <script type="text/javascript">
        function pageLoad(sender, args) {
            ...
            function TotalAmountCalculation(t) {
                var tAmt = 0;
                var perUnitDiscount = 0;
                var PerUnitServiceCharge = 0;
                var totalVAT = 0;
                var vatPercentage = t; //$("#vatPercentageLabel").text();
                ...
                PerUnitServiceCharge = $("#ServiceChargeLabel").text() / $("#totalAmountLabel").text();
                perUnitDiscount = $("#discountAmountLabel").text() / $("#totalAmountLabel").text();
                totalServiceCharge = tAmt * PerUnitServiceCharge;
                tAmt = tAmt - tAmt * perUnitDiscount;
                //totalVAT = tAmt * perUnitDiscount; //(tAmt * vatPercentage) / 100;
               
               // tAmt = tAmt - totalVAT;//- totalServiceCharge;

                $("#totalReturnAmountTextBox").val(tAmt.toFixed(2));
                $("#totalReturnVATAmountTextBox").val(totalServiceCharge.toFixed(2));
            }
