    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="false">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>Create Warehouse<span>Creating Warehouse</span></h1>
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">
                            Warehouse Create Form</h3>
                    </header>
                    <div class="clearfix"></div>
                    <div class="widget-body no-padding">
                        <div class="widget-separator grid-3">
                            <h5 class="typo">
                                Warehouse Name<span class="text-error">*</span>
                            </h5>
                            <asp:TextBox ID="warehouseNameTextBox" runat="server" CssClass="form form-full" placeholder="Warehouse Name" required="required"></asp:TextBox>
                        </div>
                        <div class="widget-separator grid-3">
                            <h5 class="typo">
                                Country
                        ...
                        <div class="widget-separator grid-3">
                            <h5 class="typo">
                                Mobile<span class="text-error">*</span>
                            </h5>
