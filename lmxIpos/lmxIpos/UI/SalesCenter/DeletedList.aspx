<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="DeletedList.aspx.cs" Inherits="lmxIpos.UI.SalesCenter.DeletedList" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional" ChildrenAsTriggers="true">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>Deleted Sales Center List<span>Deleted Sales Center List</span></h1>
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">
                            System Deleted Sales Center List</h3>
                    </header>
                            ...
                            <div id="deletedListGridContainer">
                                <asp:GridView ID="deletedListGridView" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="SalesCenterName" HeaderText="Name" />
