<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="DamageRecord.aspx.cs" Inherits="lmxIpos.UI.DamageRecordToWH.DamageRecord" %>
                    ...
                    <div class="widget-body no-padding">
                        <div class="widget-separator no-padding grid-12">
                            <div class="widget-separator no-border grid-3">
                                <h5 class="typo">Warehouse Name</h5>
                                <asp:DropDownList ID="warehouseDropDownList" runat="server" CssClass="form form-full"
                                    AutoPostBack="true" OnSelectedIndexChanged="warehouseDropDownList_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                            <div class="widget-separator no-border grid-3">
                                ...
                                <asp:GridView ID="selectedProductListGridView" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Sales Rate">
                                            <ItemTemplate>
                                                <asp:TextBox ID="ratePerUnitTextBox" runat="server" Width="50" CssClass="oQty-rpu-amt-cal autoCompeleteOff read-only"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="LastUnitPrice" HeaderText="CGS" />
