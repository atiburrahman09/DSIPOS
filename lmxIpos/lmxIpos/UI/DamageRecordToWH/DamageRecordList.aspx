<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="DamageRecordList.aspx.cs" Inherits="lmxIpos.UI.DamageRecordToWH.DamageRecordList" %>
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">
                            System Product Damage Record List of Sales Center</h3>
                    </header>
                            ...
                            <div id="damageRecordListGridContainer">
                                <asp:GridView ID="damageRecordListGridView" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="WarehouseName" HeaderText="WH Name" />
