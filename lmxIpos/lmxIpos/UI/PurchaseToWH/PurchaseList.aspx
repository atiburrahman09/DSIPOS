    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="true">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-8">
                    <i>&#xf132;</i>Warehouse Purchase Record List<span>Recorded Warehouse Purchase List</span></h1>
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">
                            System Recorded Warehouse Purchase List</h3>
                    </header>
                    <div class="widget-body no-padding">
                        <div class="widget-separator no-padding grid-12">
                            ...
                            <div class="widget-separator no-border grid-3">
                                <h5 class="typo">
                                    Date From<span class="text-error">*</span></h5>
                                <div class="grid-12">
                                    <div class="grid-1">
                            ...
                            <div class="widget-separator no-border grid-3">
                                <h5 class="typo">
                                    Date To<span class="text-error">*</span></h5>
                                <div class="grid-12">
                                    <div class="grid-1">
                                        <i class="icon-calendar"></i>
                                    </div>
