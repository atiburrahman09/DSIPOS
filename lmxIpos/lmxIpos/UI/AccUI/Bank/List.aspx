<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="lmxIpos.UI.AccUI.Bank.List" %>

<asp:Content ID="headContent" ContentPlaceHolderID="headContentPlaceHolder" runat="server">
    <link href="/Content/Style/CSSPages/BankList.css" rel="stylesheet" type="text/css" />
</asp:Content>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="true">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>Bank List<span>Created Bank List</span></h1>
            ...
            <%--<div id="body_content">
                <fieldset>
                    ...
                    <div id="bankListGridContainer" >
                        <asp:GridView ID="bankListGridView" runat="server" AutoGenerateColumns="false" CssClass="table table-hover gridView">
                            <Columns>
                                <asp:BoundField DataField="BankId" HeaderText="Bank ID" />
                                <asp:BoundField DataField="BankName" HeaderText="Bank Name" />
                                <asp:BoundField DataField="Description" HeaderText="Description" />
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="activateLinkButton" runat="server" CssClass="btn btn-mini btn-success clickProcessing"
                                            OnClick="activateLinkButton_Click">Activate</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="deactivateLinkButton" runat="server" CssClass="btn btn-mini btn-inverse clickProcessing"
                                            OnClick="deactivateLinkButton_Click">Deactivate</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="deleteLinkButton" runat="server" CssClass="btn btn-mini btn-danger clickProcessing"
                                            OnClick="deleteLinkButton_Click">Delete</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
        ...
        $(function () {
            ...
            $(".clickProcessing").live("click", function (e) {
                if (haveOverlay == 0) {
                    ...
                    bankId = $("#bankListGridView").find("tr td:nth-child(1)").eq(row).text();
                    isActive = $("#bankListGridView").find("tr td:nth-child(4)").eq(row).text();
                    ...
                    if (isActive == "True" && id == "activateLinkButton") {
                        WarningAlert("Process Redundant", "This Bank <span class='actionTopic'>already activated</span>.", "");
                    }
                    else if (isActive == "False" && id == "deactivateLinkButton") {
                        WarningAlert("Process Redundant", "This Bank <span class='actionTopic'>already deactivated</span>.", "");
                    }
                    else {
                        if (id == "activateLinkButton") {
                            msg = "Are you sure you want to <span class='actionTopic'>activate</span> this Bank?";
                        }
                        else if (id == "deactivateLinkButton") {
                            msg = "Are you sure you want to <span class='actionTopic'>deactivate</span> this Bank?";
                        }
                        else if (id == "deleteLinkButton") {
                            msg = "Are you sure you want to <span class='actionTopic'>delete</span> this Bank?";
                        }
