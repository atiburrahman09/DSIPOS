...
{
    public partial class CreditVoucherCashList : System.Web.UI.Page
    {
        ...
        protected void editLinkButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                LumexSessionManager.Add("CVCashJournalForUpdate", voucherListGridView.Rows[row.RowIndex].Cells[0].Text.ToString());
                Response.Redirect("~/UI/AccUI/CreditVoucher/UpdateCreditVoucherCash.aspx", false);
            }
            catch (Exception ex)
            {
                string message = ex.Message;
