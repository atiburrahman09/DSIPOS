<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="CreditVoucherChequeList.aspx.cs" Inherits="lmxIpos.UI.AccUI.CreditVoucher.CreditVoucherChequeList" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>C.V. Cheque List<span>Created C.V. Cheque List</span></h1>
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">
                            System Credit Voucher Cheque List</h3>
                    </header>
    ...
    <script type="text/javascript">
        function pageLoad(sender, args) {
            ...
            $("#viewDetailsModal").on("shown", function () {
                $.ajax({
                    type: "POST",
                    url: "/UI/AccUI/CreditVoucher/CreditVoucherChequeList.aspx/GetCreditVoucherViewByJournal",
