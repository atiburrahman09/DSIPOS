<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="ApproveCreditVoucherCash.aspx.cs" Inherits="lmxIpos.UI.AccUI.CreditVoucher.ApproveCreditVoucherCash" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>C.V. Cash Approval List<span>Approval C.V. Cash List</span></h1>
            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">System Credit Voucher Cash Approval List</h3>
                    </header>
                        ...
                        <div id="viewDetailsModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                    &times;</button>
                                <h3>Credit Voucher Cash - Details
                                </h3>
                            </div>
    ...
    <script type="text/javascript">
        function pageLoad(sender, args) {
            ...
            $("#viewDetailsModal").on("shown", function () {
                $.ajax({
                    type: "POST",
                    url: "/UI/AccUI/CreditVoucher/ApproveCreditVoucherCash.aspx/GetCreditVoucherViewByJournal",
