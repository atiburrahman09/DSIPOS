...
{
    public partial class CreditVoucherCashListView : System.Web.UI.Page
    {
        ...
        protected void voucherListButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    DataTable dt = debitCreditVoucher.GetCreditVoucherApprovedListByDateRangeAndAll(drpdwnSalesCenterOrWarehouse.SelectedValue, fromDate, toDate, "Cash", "");
        ...
        protected void allVoucherListButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dt = debitCreditVoucher.GetCreditVoucherApprovedListByDateRangeAndAll(drpdwnSalesCenterOrWarehouse.SelectedValue, fromDate, toDate, "Cash", "All");
        ...
        public static string GetCreditVoucherViewByJournal(string journalNumber)
        {
            try
            {
                ...
                string json = JsonConvert.SerializeObject(debitCreditVoucher.GetCreditVoucherApprovedByJournal("Cash", journalNumber));
