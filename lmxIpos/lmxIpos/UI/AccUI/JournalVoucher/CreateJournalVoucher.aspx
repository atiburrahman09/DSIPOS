            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">Create Journal Voucher Form</h3>
                    </header>
                    <div class="widget-body no-padding">
                        <div class="grid-12">
                            ...
                            <div class="widget-separator grid-3">
                                <h5 class="typo">Debit/Credit<span class="text-error">*</span>
                                </h5>
                            ...
                            <div class="widget-separator grid-3">
                                ...
                                <asp:TextBox ID="bankDropDownList" runat="server" CssClass="form form-full">
                                </asp:TextBox>
                            </div>
                            <div class="widget-separator grid-3">
                            ...
                            <div id="journalEntryListGridContainer">
                                <asp:GridView ID="journalEntryListGridView" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PayToFromCompany" HeaderText="Company" />
                                ...
                                <div id="contentContainer">
                                    <div id="journalInfo" class="widget-separator no-padding grid-12">
                                        ...
                                        <%--<div class="widget-separator grid-3">
                                            ...
                                            <asp:DropDownList ID="DropDownList1" AutoPostBack="True" runat="server" CssClass="form form-full"
                                                required="required" OnSelectedIndexChanged="payToFromTypeDropDownList_SelectedIndexChanged">
                                                <asp:ListItem Value="">Select Please</asp:ListItem>
                                                <asp:ListItem Value="com">Company</asp:ListItem>
                                                <asp:ListItem Value="ven">Vendor</asp:ListItem>
                                        ...
                                        <div class="widget-separator grid-3">
                                            ...
                                            <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form form-full"
                                                required="required">
                                            </asp:DropDownList>
                                        </div>--%>
                                         <div class="widget-separator grid-6">
                                                ...
                                                <asp:TextBox ID="payToFromCompanyTextBox" runat="server" CssClas="form form-full" Enabled="False">
                                                </asp:TextBox>
                                            </div>
                                        <div class="widget-separator grid-6">
                                            <div class="grid-12" style="background-color: #0ABFBC">
              ...
              $("#viewDetailsModal").on("shown", function () {
                  $.ajax({
                      ...
                      success: function (data) {
                          ...
                          $("#payToFromCompanyTextBox").text(obj.PayToFromCompany);
