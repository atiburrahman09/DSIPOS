    ...
    public partial class JournalVoucherList : System.Web.UI.Page
    {
        ...
        protected void voucherListButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    DataTable dt = journalVoucher.GetJournalVoucherListByDateRangeAndAll(drpdwnSalesCenterOrWarehouse.SelectedValue, fromDate, toDate, "");
        ...
        protected void editLinkButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                LumexSessionManager.Add("JournalNumberForUpdate", voucherListGridView.Rows[row.RowIndex].Cells[0].Text.ToString());
                Response.Redirect("~/UI/AccUI/JournalVoucher/UpdateJournalVoucher.aspx", false);
            }
            catch (Exception ex)
            {
                string message = ex.Message;
