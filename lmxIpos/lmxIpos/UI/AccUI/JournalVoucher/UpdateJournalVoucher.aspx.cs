        ...
        protected void updateButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    journalVoucher.Bank = bankNameTextBox.Text.Trim();//bankDropDownList.SelectedValue.Trim();
                    ...
                    journalVoucher.PayToFromCompany = payToFromCompanyTextBox.Text.Trim();//payToFromCompanyDropDownList.SelectedValue.Trim();
