<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="ViewJournalVoucher.aspx.cs" Inherits="lmxIpos.UI.AccUI.JournalVoucher.ViewJournalVoucher" %>
...
<asp:Content ID="bodyContent" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    <div class="title-sitemap grid-12">
        <h1 class="grid-6">
            <i>&#xf132;</i>View Journal Voucher<span>Created Journal Voucher View</span></h1>
    ...
    <div class="data">
        ...
        <div class="widget">
            <header class="widget-header">
                ...
                <h3 id="Header3" runat="server" class="widget-header-title">View Journal Voucher of
