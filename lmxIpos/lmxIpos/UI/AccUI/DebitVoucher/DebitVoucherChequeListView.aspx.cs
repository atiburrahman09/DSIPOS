...
{
    public partial class DebitVoucherChequeListView : System.Web.UI.Page
    {
        ...
        protected void voucherListButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    DataTable dt = debitCreditVoucher.GetDebitVoucherApprovedListByDateRangeAndAll(drpdwnSalesCenterOrWarehouse.SelectedValue, fromDate, toDate, "Cheque", "");
        ...
        protected void allVoucherListButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dt = debitCreditVoucher.GetDebitVoucherApprovedListByDateRangeAndAll(drpdwnSalesCenterOrWarehouse.SelectedValue, fromDate, toDate, "Cheque", "All");
        ...
        public static string GetDebitVoucherViewByJournal(string journalNumber)
        {
            try
            {
                ...
                string json = JsonConvert.SerializeObject(debitCreditVoucher.GetDebitVoucherApprovedByJournal("Cheque", journalNumber));
