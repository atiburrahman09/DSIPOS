<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="DebitVoucherCashListView.aspx.cs" Inherits="lmxIpos.UI.AccUI.DebitVoucher.DebitVoucherCashListView" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-6">
                    <i>&#xf132;</i>D.V. Cash List View<span>Created D.V. Cash List View</span></h1>
            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">System Debit Voucher Cash List View</h3>
                    </header>
                    <div class="widget-body no-padding">
                        <div class="widget-separator no-padding grid-12">
                            ...
                            <div class="widget-separator no-border grid-6" style="margin-top: 27px;">
    ...
    <script type="text/javascript">
        function pageLoad(sender, args) {
            ...
            $("#viewDetailsModal").on("shown", function () {
                $.ajax({
                    type: "POST",
                    url: "/UI/AccUI/DebitVoucher/DebitVoucherCashListView.aspx/GetDebitVoucherViewByJournal",
