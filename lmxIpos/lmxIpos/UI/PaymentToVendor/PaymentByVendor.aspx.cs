...
{
    public partial class PaymentByVendor : System.Web.UI.Page
    {
        ...
        protected void GetVendorPayableList()
        {
            ...
            try
            {
                ...
                {
                    DataTable dt = receivePayment.GetVendorPayableList(vendorDropDownList.SelectedValue, drpdwnAccountOn.SelectedValue, drpdwnSalesCenterOrWarehouse.SelectedValue);
