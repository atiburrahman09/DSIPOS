<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" EnableEventValidation="false" MaintainScrollPositionOnPostback="true"
    CodeBehind="CreatePurchase.aspx.cs" Inherits="lmxIpos.UI.PurchaseToSC.CreatePurchase" %>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="True">
        <ContentTemplate>
            <div class="title-sitemap grid-12">
                <h1 class="grid-8">
                    <i>&#xf132;</i>Create Purchase Record<span>Creating Sales Center Purchase
                        Record</span></h1>
            ...
            <div class="data">
                ...
                <div class="widget">
                    <header class="widget-header">
                        ...
                        <h3 id="Header3" runat="server" class="widget-header-title">Create Sales Center Purchase Record Form</h3>
                    </header>
                    <div class="widget-body no-padding">
                        <div class="widget-separator no-padding grid-12">
                            <div class="widget-separator no-border grid-3">
                                <h5 class="typo">Sales Center Name<span class="text-error">*</span>
                                </h5>
                                <asp:DropDownList ID="salesCenterDropDownList" required="required" runat="server" AutoPostBack="True"
                        ...
                        <div class="widget-separator">
                            <h4 class="typo">Purchase Information</h4>
                        </div>
                        <div class="grid-12">
                        ...
                        <div class="widget-separator no-padding grid-12">
                            ...
                            <div class="widget-separator no-border grid-3">
                                ...
                                <asp:TextBox ID="totalPayableTextBox" runat="server" CssClass="text-error bolder read-only form form-full"
                                    placeholder="" Text="0.00"></asp:TextBox>
                            </div>
                            <div class="widget-separator no-border grid-3">
                            ...
                            <div class="widget-separator no-border grid-3">
                                ...
                                <asp:TextBox ID="paidAmountTextBox" onfocus="this.select()" runat="server" CssClass="text-success form form-full"
                                    placeholder="Paid Amount" Text="0.00"></asp:TextBox>
                            </div>
                        </div>
                        <div class="widget-separator no-padding grid-12">
                            <div class="widget-separator no-border grid-3">
                                <h5 class="typo">Vendor Name<span class="text-error">*</span>
                                </h5>
                            ...
                            <div class="widget-separator no-border grid-3">
                                <div class="grid-12">
                                    <h5 class="typo">Vendor Order Date<span class="text-error">*</span></h5>
                                </div>
                                <div class="grid-12">
                                    <div class="grid-1">
                            ...
                            <div class="widget-separator no-border grid-3">
                                <h5 class="typo">Received Date<span class="text-error">*</span>
                                </h5>
                                <div class="grid-12">
                                    <div class="grid-1">
                                        <i class="icon-calendar"></i>
                        ...
                        <div class="widget-separator no-border grid-12 text-center">
                            <asp:Button ID="saveButton" CssClass="btn btn-info btn-large btn-3d text-center" Enabled="false" runat="server"
