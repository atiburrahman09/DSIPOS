                ...
                <div class="widget">
                    ...
                    <div class="widget-body no-padding">
                        <div class="widget-separator grid-12">
                            ...
                            <div class="widget-separator no-border grid-3">
                                <h5 class="typo">Amount<span class="text-error">*</span></h5>
                            ...
                            <div class="widget-separator no-border grid-3">
                                <h5 class="typo">Account Head<span class="text-error">*</span></h5>
                        ...
                        <div class="widget-separator grid-12">
                            <div class="widget-separator no-border grid-3">
                                <div class="grid-12">
                                    <h5 class="typo">Account On<span class="text-error">*</span></h5>
                                </div>
                                <div class="grid-11">
