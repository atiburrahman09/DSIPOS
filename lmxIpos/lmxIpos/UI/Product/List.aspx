...
<asp:Content ID="bodyContent" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel1" ChildrenAsTriggers="true">
            ...
            <div class="data">
                ...
                <div class="widget">
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <div class="widget-separator no-border grid-3">
                            <h5 class="typo">Search By Barcode or Name </h5>
                            <asp:TextBox ID="txtbxProductSearch" runat="server" onfocus="this.select()" AutoPostBack="true" OnTextChanged="txtbxProductSearch_TextChanged"></asp:TextBox>
                            ...
                            <div id="productListGridContainer">
                                <asp:GridView ID="productListGridView" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="RatePerUnit" HeaderText="Price" />
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="txtbxProductSearch" EventName="TextChanged" />
        ...
        function pageLoad(sender, args) {
            ...
            $.ajax({
                ...
                success: function (d) {
                    ...
                    $('#txtbxProductSearch').typeahead({ source: array });
        ...
        $(function () {
            ...
            $(".clickProcessing").live("click", function (e) {
                if (haveOverlay == 0) {
                    ...
                    isActive = $("#productListGridView").find("tr td:nth-child(9)").eq(row).text();
